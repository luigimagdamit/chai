...
use crate::llvm::llvm_print::{llvm_fmt_string_int, llvm_main_close, llvm_main_start, llvm_print_define, llvm_print_i32_define};
use crate::parser::parser::Parser;

pub fn jit_compile(source: &str) -> io::Result<()>{
