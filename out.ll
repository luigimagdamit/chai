...
entry:
	...
	%42 = mul i32 %i_1, 30
	store i32 %42, i32* %i		 ; set symbol (symbol.rs)

	%flag = alloca i1
	%i_2 = load i32, i32* %i 			 ; LlvmLoad load_i32
	%43 = add i32 %i_2, 0				; expr_pop
	call void @print_i32(i32 %43)
	...
	%51 = icmp eq i32 2, 3
	%52 = add i1 %51, 0				; expr_pop
	call void @print_i1(i1 %52)

	%54 = add i1 1, 0				; expr_pop
	call void @print_i1(i1 %54)

	%56 = add i1 0, 0				; expr_pop
	call void @print_i1(i1 %56)

	%seppuku = alloca i8*
	; pushing a new string on the stack ...
	%58 = getelementptr inbounds [21 x i8], [21 x i8]* @str4, i32 0, i32 0 ; llvm_retrieve_static_string		;LLVM Register for String @ ExprCount 58(variable.rs) 				; Printing a string type (expr_pop - register increment by LlvmTempRegister)
	store i8* %58, i8** %seppuku				 ; storing item in a stack variable

	%seppuku_0 = load i8*, i8** %seppuku ; 			 Llvm Load String
	%59 = getelementptr inbounds [21 x i8], [21 x i8]* @str4, i32 0, i32 0 ; llvm_retrieve_static_string		;LLVM Register for String @ ExprCount 59(variable.rs) 				; Printing a string type (expr_pop - register increment by LlvmTempRegister)
