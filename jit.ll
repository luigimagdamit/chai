...
;	; pushing a new string on the stack ..."beignets"
	...
	%breakfast = alloca i8*store i8* %2, i8** %breakfast
;	; pushing a new string on the stack ..."cafe au lait"
	...
	%beverage = alloca i8*store i8* %4, i8** %beverage

	%breakfast_0 = load i8*, i8** %breakfast
;	ast mode
;	; breakfast;
	call i32 (i8*, ...) @printf(i8* %breakfast_0)

	%beverage_0 = load i8*, i8** %beverage
;	ast mode
;	; beverage;
	call i32 (i8*, ...) @printf(i8* %beverage_0)
	%hungry = alloca i1store i1 1, i1* %hungry
	%snacks = alloca i32store i32 10, i32* %snacks
	br label %cond8

cond8:

	%snacks_0 = load i32, i32* %snacks
...
body8:
	...
	%snacks_1 = load i32, i32* %snacks
	%10 = sub i32 %snacks_1, 1
	store i32 %10, i32* %snacks		 ; set symbol (symbol.rs)


	%hungry_0 = load i1, i1* %hungry
...
;	;awww "nom";
	...
	store i1 0, i1* %hungry		 ; set symbol (symbol.rs)
...
;	;awww "zzz";
	...
	store i1 1, i1* %hungry		 ; set symbol (symbol.rs)
