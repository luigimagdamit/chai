...
body10:
	...
	%18 = getelementptr inbounds [11 x i8], [11 x i8]* @str3, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	call i32 (i8*, ...) @printf(i8* %18)

	;	; pushing a new string on the stack ..."nom"
	%20 = getelementptr inbounds [5 x i8], [5 x i8]* @str4, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
...
else1:
	...
	%22 = getelementptr inbounds [11 x i8], [11 x i8]* @str5, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	call i32 (i8*, ...) @printf(i8* %22)

	;	; pushing a new string on the stack ..."zzz"
	%24 = getelementptr inbounds [5 x i8], [5 x i8]* @str6, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
...
exit10:
	%26 = getelementptr inbounds [13 x i8], [13 x i8]* @str0, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	...
	%28 = getelementptr inbounds [14 x i8], [14 x i8]* @str7, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	...
	%44 = getelementptr inbounds [13 x i8], [13 x i8]* @str1, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	call i32 (i8*, ...) @printf(i8* %44)
	%46 = getelementptr inbounds [13 x i8], [13 x i8]* @str7, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	call i32 (i8*, ...) @printf(i8* %46)

	;	; pushing a new string on the stack ..."here is me declaring a variable"
	%48 = getelementptr inbounds [33 x i8], [33 x i8]* @str8, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	call i32 (i8*, ...) @printf(i8* %48)

	;	; pushing a new string on the stack ..."this is the variable"
	%50 = getelementptr inbounds [22 x i8], [22 x i8]* @str9, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
	...
	%58 = getelementptr inbounds [22 x i8], [22 x i8]* @str10, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
...
exit67:
	...
	%71 = getelementptr inbounds [5 x i8], [5 x i8]* @str11, i32 0, i32 0 ; llvm_retrieve_static_string ; place() in impl StringConstant
