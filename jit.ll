...
;	; pushing a new string on the stack ..."ok shutting down now"
	%55 = getelementptr inbounds [21 x i8], [21 x i8]* @str4, i32 0, i32 0 ; llvm_retrieve_static_string		;LLVM Register for String @ ExprCount 55(variable.rs) 				; Printing a string type (expr_pop - register increment by LlvmTempRegister)
